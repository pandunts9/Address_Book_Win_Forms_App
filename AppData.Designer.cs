...
namespace Address_Book_Win_Forms_App {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class AddressBookDataTable : global::System.Data.TypedTableBase<AddressBookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AddressBookRow AddAddressBookRow(string FullName, string Email, int PhoneNumber, string Address) {
        ...
        public partial class AddressBookRow : global::System.Data.DataRow {
            ...
            public int PhoneNumber {
                get {
                    try {
                        return ((int)(this[this.tableAddressBook.PhoneNumberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Address_Book_Win_Forms_App.AppDataTableAdapters {
    ...
    public partial class AddressBookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[AddressBook] ([FullName], [Email], [PhoneNumber], [Address]) V" +
                "ALUES (@FullName, @Email, @PhoneNumber, @Address);\r\nSELECT id, FullName, Email, " +
                "PhoneNumber, Address FROM AddressBook WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[AddressBook] SET [FullName] = @FullName, [Email] = @Email, [PhoneNumber] = @PhoneNumber, [Address] = @Address WHERE (([id] = @Original_id) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = @Original_PhoneNumber)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT id, FullName, Email, PhoneNumber, Address FROM AddressBook WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Address_Book_Win_Forms_App.Properties.Settings.Default.StudentConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, FullName, Email, PhoneNumber, Address FROM dbo.AddressBook";
        ...
        public virtual int Fill(AppData.AddressBookDataTable dataTable) {
        ...
        public virtual AppData.AddressBookDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AppData.AddressBookDataTable dataTable = new AppData.AddressBookDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AppData.AddressBookDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_FullName, string Original_Email, global::System.Nullable<int> Original_PhoneNumber, string Original_Address) {
        ...
        public virtual int Insert(string FullName, string Email, global::System.Nullable<int> PhoneNumber, string Address) {
            if ((FullName == null)) {
        ...
        public virtual int Update(string FullName, string Email, global::System.Nullable<int> PhoneNumber, string Address, int Original_id, string Original_FullName, string Original_Email, global::System.Nullable<int> Original_PhoneNumber, string Original_Address, int id) {
            if ((FullName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, string Email, global::System.Nullable<int> PhoneNumber, string Address, int Original_id, string Original_FullName, string Original_Email, global::System.Nullable<int> Original_PhoneNumber, string Original_Address) {
            return this.Update(FullName, Email, PhoneNumber, Address, Original_id, Original_FullName, Original_Email, Original_PhoneNumber, Original_Address, Original_id);
        }
    }
